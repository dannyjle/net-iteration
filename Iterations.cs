...
namespace DotnetIteration
{
    ...
    public static class Iteration
    {
        ...
        */
        ...
        {
            var newListOfNumbers = numbers.Where(number => number % 2 == 0);
            return newListOfNumbers;
        }
        ...
        {
            var newListOfNumbers = numbers.Where((number, index) => index % 2 == 0);
            return newListOfNumbers;
        }
        ...
        {
            var newListForYearToMatch = movies.Where(movie => movie.Year == yearToMatch && movie.Score > 90).Select(movie => movie.Name);
            return newListForYearToMatch;
        }
        ...
        {
            var oddBall = numbers.All(number => number % 2 == 1);
            return oddBall;
        }
